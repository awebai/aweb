-- Optional tenant-aware fields (clean start)

-- Projects may be partitioned by an external tenant in hosted/proxy deployments.
...
-- - tenant_id is set → slug must be unique per tenant among active projects
...
-- API keys may be associated with a user for ownership and permissions.
