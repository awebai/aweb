...
func init() {
	...
	projectCreateCmd.Flags().StringVar(&initNamespaceSlug, "namespace", "", "Managed owner slug for addresses under <owner>.aweb.ai")
	projectCreateCmd.Flags().StringVar(&initNamespaceSlug, "namespace-slug", "", "Managed owner slug (alias for --namespace)")
