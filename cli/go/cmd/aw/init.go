...
func init() {
	...
	initCmd.Flags().StringVar(&initAlias, "local-name", "", "Local workspace routing name (optional; default: server-suggested)")
	initCmd.Flags().StringVar(&initAlias, "alias", "", "Deprecated alias for --local-name")
	markDeprecatedHiddenFlag(initCmd, "alias", "local-name")
