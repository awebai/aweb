"""library's app-emit-credential signer.
...
primitives (the same ones library's cert-auth path uses) — it does NOT define a
second canonicalization. This is the v1 stopgap app event emit credential; library
